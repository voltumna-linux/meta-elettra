...
SRC_URI = " \
	https://bintray.com/tango-controls/maven/download_file?file_path=org%2Ftango%2Ftools%2Fpogo%2Fgui%2FPogo%2F${PV}%2FPogo-${PV}.jar;downloadfilename=Pogo-${PV}.jar;unpack=0 \
	file://pogo \
"
